Public Class SnakeGame
    ...
    Private Sub Die()
        InputNameForm.Show()
        DisplayMessage("Press Enter to play or Escape to back to main menu.")
    ...
    Private Sub UpdateUI()
        ...
        ElseIf rectFood.Contains(cMovement.Location) Then
            ...
            intScore = 10
            scoreTotal = scoreTotal + intScore
            InputNameForm.scorePlayer = scoreTotal

            Text = "Score: " + scoreTotal.ToString
    ...
    Private Sub SnakeGame_Load(ByVal sender As Object, _
        ...
        Select Case e.KeyCode
            ...
            Case Keys.Escape
                ...
                If blnMoving Then
                    ...
                    DisplayMessage("Press Enter to continue or Escape to back to main menu.")
